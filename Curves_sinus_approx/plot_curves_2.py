...
costs_sgd = cPickle.load(open('target_sgd_2.pkl', 'r'))['costs']
costs_momentum = cPickle.load(open('target_momentum_2.pkl', 'r'))['costs']
#costs_momentum_no_inverse = cPickle.load(open('target_momentum_no_inverse.pkl', 'r'))['costs']
costs_adagrad = cPickle.load(open('target_adagrad_2.pkl', 'r'))['costs']
